...
function filterStudentsByGrade(students, grade) {
  ...
  let sortedStudents = students.filter((value) => value["grade"] === grade);
...
function compareArrays(arr1, arr2) {
  arr1.sort((prev, current) => prev - current);
  arr2.sort((prev, current) => prev - current);
  console.assert(
...
function validateUserInput(userInput) {
  if (userInput["username"]) {
    ...
    } else console.error("Помилка: пароль відсутній!");
  } else console.error("Помилка: ім'я користувача відсутнє!");
